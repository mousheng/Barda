...
import static com.barda.plugin.googlesheets.GoogleSheetError.GOOGLESHEETS_EMPTY_QUERY_PARAM;
import static com.barda.plugin.googlesheets.GoogleSheetError.GOOGLESHEETS_REQUEST_ERROR;
import static com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandler.APPEND_DATA;
import static com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandler.CLEAR_DATA;
import static com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandler.DELETE_DATA;
import static com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandler.READ_DATA;
import static com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandler.UPDATE_DATA;
...
import com.barda.plugin.googlesheets.model.GoogleSheetsActionRequest;
import com.barda.plugin.googlesheets.model.GoogleSheetsAppendDataRequest;
import com.barda.plugin.googlesheets.model.GoogleSheetsClearDataRequst;
import com.barda.plugin.googlesheets.model.GoogleSheetsDatasourceConfig;
import com.barda.plugin.googlesheets.model.GoogleSheetsDeleteDataRequest;
import com.barda.plugin.googlesheets.model.GoogleSheetsQueryExecutionContext;
import com.barda.plugin.googlesheets.model.GoogleSheetsReadDataRequest;
import com.barda.plugin.googlesheets.model.GoogleSheetsUpdateDataRequest;
import com.barda.plugin.googlesheets.model.ServiceAccountJsonUtils;
import com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandler;
import com.barda.plugin.googlesheets.queryhandler.GoogleSheetsActionHandlerFactory;
...
public class GoogleSheetsPlugin extends Plugin {
    ...
    public static class GoogleSheetsEngine implements DatasourceQueryEngine<GoogleSheetsDatasourceConfig, Object, GoogleSheetsQueryExecutionContext> {
         ...
         */
        @Override
        public Mono<GoogleSheetsQueryExecutionContext> doBuildQueryExecutionContextMono(GoogleSheetsDatasourceConfig connectionConfig, Map<String, Object> queryConfig, Map<String, Object> requestParams, QueryVisitorContext queryVisitorContext) {
            ...
            context.setServiceAccount(connectionConfig.getServiceAccount());
