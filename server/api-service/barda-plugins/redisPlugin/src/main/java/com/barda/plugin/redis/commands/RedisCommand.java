package com.barda.plugin.redis.commands;

import static com.barda.plugin.redis.constants.RedisFieldName.COMMAND;
import static com.barda.plugin.redis.constants.RedisFieldName.COUNT;
import static com.barda.plugin.redis.constants.RedisFieldName.DESTINATION;
import static com.barda.plugin.redis.constants.RedisFieldName.FIELD;
import static com.barda.plugin.redis.constants.RedisFieldName.FIELDS;
import static com.barda.plugin.redis.constants.RedisFieldName.INDEX;
import static com.barda.plugin.redis.constants.RedisFieldName.KEY;
import static com.barda.plugin.redis.constants.RedisFieldName.KEYS;
import static com.barda.plugin.redis.constants.RedisFieldName.MAX;
import static com.barda.plugin.redis.constants.RedisFieldName.MEMBER;
import static com.barda.plugin.redis.constants.RedisFieldName.MIN;
import static com.barda.plugin.redis.constants.RedisFieldName.PATTERN;
import static com.barda.plugin.redis.constants.RedisFieldName.SCORE;
import static com.barda.plugin.redis.constants.RedisFieldName.SOURCE;
import static com.barda.plugin.redis.constants.RedisFieldName.START;
import static com.barda.plugin.redis.constants.RedisFieldName.STOP;
import static com.barda.plugin.redis.constants.RedisFieldName.VALUE;
import static com.barda.sdk.plugin.common.QueryExecutionUtils.getStringValueSafelyFromFormData;
...
public abstract class RedisCommand {
    ...
    /**
     * 构造函数，用于创建 RedisCommand 类的实例。
     *
     * @param formData 包含 Redis 命令参数的 Map
     */
