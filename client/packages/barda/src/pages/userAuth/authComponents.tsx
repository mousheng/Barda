...
import { CheckBox, PackUpIcon, TacoButton } from "barda-design";
...
const AuthCard = styled.div`
  ...
  width: 480px;
  background: #ffffff;
  box-shadow: 0 0 #0000,  0 0 #0000, 0 4px 14px rgba(0, 0, 0, .25);
  border-radius: 16px;
  padding: 28px 36px;
  margin-top: 40px;
...
export const TermsAndPrivacyInfo = (props: { onCheckChange: (e: CheckboxChangeEvent) => void }) => {
  ...
  return (
    <TermsAndPrivacyContent>
      <CheckBox defaultChecked onChange={(e: CheckboxChangeEvent) => props.onCheckChange(e)} />
