...
import { ApplicationMeta, AppUILayoutType } from "constants/applicationConstants";
...
const SettingsDiv = styled.div`
  ...
  :where(.css-dev-only-do-not-override-98ntnt).ant-anchor-wrapper .ant-anchor .ant-anchor-link-active>.ant-anchor-link-title {
    color: #1677ff;
  }
    ...
    return (
        <SettingsDiv>
            <SettingsHeader>
                ...
                <CloseButton
                    onClick={() => setPanelStatus({ ...panelStatus, left: false })}>
                    <DoubleLeftOutlined />
                </CloseButton>
            </SettingsHeader>
