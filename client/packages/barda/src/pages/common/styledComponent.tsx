...
import { CommonGrayLabel, EmptyDataIcon } from "barda-design";
...
export const LeftPanel = styled(StyledCard) <{ menuKey?: string }>`
  width: ${(props) => props.menuKey === 'setting' ? '489px' : '289px'};
  display: block;
`;
...
export const ReadOnlyMask = memo((props: {
