...
import { RadioCheckedIcon } from "barda-design";
import { SwitchCheckedIcon } from "barda-design";
import { RequiredIcon } from "barda-design";
import { SuccessIcon } from "barda-design";
import {
  CustomModalStyled,
  ModalNameDiv,
  ScrollBarStyled,
...
function CreateModal(props: CreateModalProp) {
  ...
  return (
    ...
    >
      ...
      <ScrollBarStyled
        style={{
          height: themeList?.length ? ((themeList?.length ?? 0) > 3 ? "363px" : "313px") : "156px",
          marginBottom: (themeList?.length ?? 0) > 3 ? "4px" : "0",
        }}
      >
