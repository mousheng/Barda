...
import { AddIcon, CustomModal, EditPopover } from "barda-design";
...
import { usePermissionMenuItems } from "@barda/pages/setting/permission/permissionMenuItems";
    ...
    <Level1SettingPageContentWithList>
      ...
      <div>
        <Table
          ...
          pagination={false}
          onRow={(record) => ({
            onClick: () => history.push(buildGroupId((record as any).key)),
          })}
          columns={[
            {
