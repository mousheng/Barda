...
export const normalAppListSelector = createSelector(
  [(state: AppState) => state.ui.application.applicationList],
  (applicationList) => applicationList.filter((app) => app.applicationStatus === "NORMAL")
);
