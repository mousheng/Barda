...
import { labelCss, Section, Tooltip, UnderlineCss } from "barda-design";
import { ValueFromOption } from "barda-design";
import { isEmpty } from "lodash";
import { ReactNode } from "react";
import styled, { css } from "styled-components";
import { AlignLeft } from "barda-design";
import { AlignRight } from "barda-design";
import { StarIcon } from "barda-design";
        ...
        {!props.hidden && !isEmpty(props.text) && (
          ...
          >
            <Tooltip
              ...
              placement="top"
              color="#2c2c2c"
              getPopupContainer={(node: any) => node.closest(".react-grid-layout")}
            >
