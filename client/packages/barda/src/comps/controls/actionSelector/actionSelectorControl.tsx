...
import { SetPersistentStateAction } from "./setPersistentStateAction";
...
const ActionMap = {
  ...
  setPersistentState: SetPersistentStateAction,
...
export const ActionOptions: { label: string; value: keyof typeof ActionMap }[] = [
  ...
  {
    label: trans("eventHandler.setPersistentState"),
    value: "setPersistentState",
  },
  {
