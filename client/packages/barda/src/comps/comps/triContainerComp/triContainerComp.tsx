...
import { fromRecord, Node } from "barda-core";
import { nodeIsRecord } from "barda-core";
...
import { ControlNode } from "barda-design";
...
export class TriContainerComp extends TriContainerBaseComp implements IContainer {
  ...
  getAllLayouts(): Layout {
    return _.assign(
      {},
      ...this.allContainers().flatMap(c =>
        _.size(c.children.items.children) ?
          [{ ...c.getAllLayouts(), ...c.children.layout.value }] :
          []
      )
    );
  }
