...
import { ACCOUNT_PATTERN, checkPsidno, EMAIL_PATTERN, ID_CARD, URL_PATTERN } from "util/stringUtils";
import { MultiBaseComp, RecordConstructorToComp, RecordConstructorToView } from "barda-core";
...
export const TextInputValidationOptions = [
  {
    label: trans("validationDesc.text"),
    value: "Text",
    extra: /.*/,
    help: "",
  },
  {
    ...
    help: trans("validationDesc.accountHelp"),
  },
  {
    label: trans("validationDesc.email"),
    value: "Email",
    extra: EMAIL_PATTERN,
    help: trans("validationDesc.emailHelp"),
  },
  {
    label: "URL",
    value: "URL",
    extra: URL_PATTERN,
    help: trans("validationDesc.urlHelp"),
  },
  {
    label: trans("validationDesc.idCard"),
    value: "IDCARD",
    extra: ID_CARD,
    help: trans("validationDesc.idCardHelp"),
  },
  {
    label: trans("validationDesc.regex"),
    value: "Regex",
    extra: undefined,
    help: trans("validationDesc.regexHelp"),
  },
] as const;
...
export const textInputValidate = (
  ...
  // 补充验证身份证号是否合法
  if (optionValue === "IDCARD" && !checkPsidno(value))
    return { validateStatus: "error", help: valueInfoMap[optionValue].help };
