...
test("test resolveParsedValue", async () => {
  const files = await Promise.all([
    getFile("packages/barda/src/comps/comps/fileComp/fileComp.test.csv"),
    getFile("packages/barda/src/comps/comps/fileComp/fileComp.test.json"),
    getFile("packages/barda/src/comps/comps/fileComp/fileComp.test.png"),
    getFile("packages/barda/src/comps/comps/fileComp/fileComp.test.txt"),
    getFile("packages/barda/src/comps/comps/fileComp/fileComp.test.xlsx"),
  ]);
