...
import { controlItem } from "barda-design";
...
export const TableEventOptions = [
  ...
  {
    label: trans("table.rowDoubleClick"),
    value: "rowDoubleClick",
    description: trans("table.rowDoubleClick"),
  },
  {
...
const tableChildrenMap = {
  ...
  // dataIndexMap_Cache: stateComp<JSONObject>({}),
