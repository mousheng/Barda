...
import { changeChildAction, ConstructorToView } from "barda-core";
import {
  AlignBottom,
  AlignClose,
  AlignTop,
...
const ToolbarWrapper = styled.div<{
  ...
  overflow: auto;
  ${(props) => props.$style && props.$theme && getStyle(props.$style, props.$filtered, props.$theme, props.$position)}
`;
...
function ToolbarPopover(props: {
  ...
  return (
    <Popover
      open={visible}
      styles={{root:{pointerEvents: "auto"}, container:{padding: 0}}}
      content={
        <div
          ref={popOverRef}
          tabIndex={-1}
