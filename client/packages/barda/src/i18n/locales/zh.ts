export const zh = {
    ...
    gridCompOperator: {
        ...
        cutCompsSuccess: "组件剪切成功!您可以使用 {pasteKey} 进行粘贴,或使用 {undoKey} 撤销操作.",
        copyCompsSuccess: "组件复制成功! 您可以使用 {pasteKey} 进行粘贴.",
        pasteCompsSuccess: "组件粘贴成功!",
        pasting: "粘贴中，请等待...",
    ...
    eventHandler: {
        ...
        method: "方法",
        setTempState: "设置临时状态",
        setPersistentState: "设置持久状态",
        operation: "操作",
        set: "设置",
        remove: "删除",
        clear: "清空",
        selectOrInputKey: "选择或输入键名",
        key: "键",
        value: "值",
        state: "状态",
    ...
    themeDetail: {
        ...
        borderRadius: "边框圆角",
        borderRadiusDesc: "大多数组件使用默认的边框圆角半径",
        chart: "图表样式",
        chartDesc: "Echarts",
        echartsJson: "主题配置",
    },
    style: {
        ...
        tips: "提示",
        noStyleAdded: "未添加样式",
        inputColorError: "参数必须为CSS颜色的格式类型",
        inputColorOrBooleanError: "参数的类型必须是CSS color或Boolean",
        inputBorderError: "参数的类型必须是CSS中border的格式类型",
        inputPaddingOrMarginError: "参数的类型必须是CSS中padding/margin的格式类型",
        inputRadiusError: "参数的类型必须是CSS中radius的格式类型",
        compBackground: "组件背景",
        compBorder: "组件边框",
        compRadius: "组件边框圆角",
        compPadding: "组件内边距",
    ...
    validationDesc: {
        text: "文本",
        email: "邮箱",
        emailHelp: "请输入有效的电子邮件地址",
        urlHelp: "请输入有效的URL链接",
        regex: "自定义正则表达式",
        regexHelp: "请输入与正则表达式匹配的内容",
        account: "账号",
        accountHelp: "账号首位必须字母，且账号只能包含字母、数字、下划线，字符数大于4且小于15",
        idCard: "身份证",
        idCardHelp: "请输入有效的身份证号码",
    ...
    query: {
        ...
        authSource: "验证数据库",
        cloudHosting:
            "云托管的Barda无法访问您的本地服务,如使用127.0.0.1或localhost.请尝试连接公共网络数据源或使用反向代理来访问您的私有服务.",
        notCloudHosting:
            "对于Docker托管部署,Barda使用桥接网络,因此对于主机地址,127.0.0.1和localhost是无效的.要访问本地机器上的数据源,请参考以下链接",
        ...
        save: "保存",
        whitelist: "白名单",
        whitelistTooltip: "当需要时,将以下Barda的IP地址添加到数据源的白名单中.",
        address: "地址:",
        ...
        headers: "请求头",
        Parameters: "参数",
        unexpectedTimeout: "意外的超时，可能是你的JS代码返回了JS沙箱中的受限对象。",
    },
    sqlQuery: {
        keyValuePairs: "键值对",
        object: "对象",
    ...
    uiComp: {
        ...
        qrCodeCompKeywords: "",
        statisticCardCompName: "统计卡片",
        statisticCardCompDesc: "统计卡片组件，用于展示统计数据",
    ...
    table: {
        ...
        selectTags: "选择标签",
        tagConfig: "标签配置",
        allowCustomTags: "自定义标签",
        allowCustomTagsTooltip: "开启后，用户可以输入自定义标签。关闭后，用户只能从标签配置中的预设标签中选择。",
        colorMap: "颜色映射",
        colorMapTooltip: "设置标签颜色映射，支持指定特定标签的颜色或使用default设置默认颜色。支持的颜色类型：success/processing/error/warning/default，普通颜色名如red/orange/blue，或十六进制颜色如#ff0000/#123456。",
        date: "日期",
        dateTime: "日期时间",
        badgeStatus: "状态",
        button: "按钮",
        ...
        checkedChildren: "开启文字",
        unCheckedChildren: "关闭文字",
        allColumn: "全部",
        visibleColumn: "可见",
    ...
    statisticCard: {
        title: "标题",
        titleTooltip: "统计卡片的标题文本",
        value: "数值",
        valueTooltip: "统计卡片显示的数值",
        valueDesc: "统计卡片的数值",
        prefix: "前缀",
        prefixTooltip: "显示在数值前面的前缀文本，如货币符号、单位等",
        suffix: "后缀",
        suffixTooltip: "显示在数值后面的后缀文本，如单位、百分比符号等",
        precision: "精度",
        precisionTooltip: "数值的小数位数，范围0-20",
        prefixColor: "前缀颜色",
        suffixColor: "后缀颜色",
        secondaryIndicator: "副指标",
        showSecondaryIndicator: "显示副指标",
        showSecondaryIndicatorTooltip: "在主指标旁显示副指标",
        secondaryValue: "副数值",
        secondaryValueTooltip: "显示在主指标旁的副数值",
        secondaryPrefix: "副前缀",
        secondaryPrefixTooltip: "显示在副数值前面的前缀文本",
        secondarySuffix: "副后缀",
        secondarySuffixTooltip: "显示在副数值后面的后缀文本",
        secondaryPrecision: "副精度",
        secondaryPrecisionTooltip: "副数值的小数位数，范围0-20",
        secondaryValueColor: "副数值颜色",
        secondaryValueFontSize: "副数值字号",
        secondaryPrefixColor: "副前缀颜色",
        secondarySuffixColor: "副后缀颜色",
        size: "尺寸",
        sizeTooltip: "普通保持默认留白，紧凑会压缩内边距和图标尺寸",
        sizeNormal: "普通",
        sizeCompact: "紧凑",
        icon: "图标",
        iconTooltip: "统计卡片的图标",
        enableAnimation: "动画效果",
        enableAnimationTooltip: "开启后，数值将以动画效果从0开始递增显示",
        titleColor: "标题颜色",
    ...
    modalComp: {
        ...
        codeOnlyClose: "禁止用户关闭",
        codeOnlyCloseTooltip: "启用后，对话框只能通过代码关闭，不显示关闭按钮，【编辑时】允许点击蒙版关闭",
    ...
    advanced: {
        ...
        AuthOrgLoginUrlDesc: "组织登录地址 (点击复制)",
        AuthOrgRedirectUriDesc: "OAuth重定向URI (配置OAuth提供商时使用，点击复制)",
        saveBtn: "保存",
    ...
    branding: {
        ...
        faviconTitle: "网站图标（Favicon）",
        faviconHelp: "推荐ICO，支持 JPG、PNG、SVG 格式",
        brandNameTitle: "品牌名称",
        headColorTitle: "顶部颜色",
        logoContainsName: "顶部不显示品牌名称",
        save: "保存",
        saveSuccessMsg: "保存成功",
        upload: "点击上传",
        typeError: "您只能上传 {fileTypes} 类型文件!",
        sizeError: "图片须小于 {size}MB!",
    },
    networkMessage: {
        500: "服务器忙碌,请稍后重试",
        0: "无法连接到服务器,请检查您的网络",
    ...
    apiMessage: {
        ...
        functionNotSupported: "当前版本不支持此功能.请联系 Barda 业务团队升级您的账户",
    },
    globalErrorMessage: {
    ...
    appSetting: {
        ...
        themeCreate: "创建主题",
        embeddingMode: "嵌入模式",
        embeddingModeDes: "该功能用于控制顶部菜单在预览模式下的显示状态。\n当您需要将此程序嵌入到其他网页中时，该功能尤为重要。\n另外，您还可以通过在页面链接中添加template=true参数来隐藏顶部菜单。",
        normal: "正常",
        embedding: "嵌入",
        layoutMode: "布局模式",
        layoutModeDes: "网格模式：组件只能拖放在网格中;\n自由模式：组件可以自由拖放。",
        gridMode: "网格模式",
        freeMode: "自由模式",
        changeLayoutMode: "切换布局模式",
        changeLayoutModePrompt: "从自由模式切换到网格模式可能会改变组件位置，确定要切换吗？",
        confirmText: "确定",
    },
    customShortcut: {
        title: "自定义快捷键",
    ...
    userAuth: {
        ...
        selectOrgTitle: "选择工作空间",
        selectOrgDesc: "您已加入多个工作空间，请选择一个进入",
        primaryOrg: "主组织",
        account: "帐户",
    ...
    preLoad: {
        ...
        jsLibraryInstallFailedCloud: "可能该库在沙盒中不可用,[文档](https://docs.Barda.com.cn/build-apps/write-javascript/use-third-party-libraries#manually-import-libraries)\n{message}",
    ...
    componentDoc: {
        ...
        demoText: "Barda 是一个开发人员友好的开源低代码平台,可在几分钟内构建内部应用.",
        submit: "提交",
        style: "样式",
        danger: "危险",
        warning: "警告",
    ...
    idSource: {
        ...
        deleteSuccess: "删除成功",
        deleteTip: "提示",
        deleteContent: "此操作将永久删除该身份源配置，且无法撤销。是否确定继续？",
        deleteImpactTip: "删除后，已绑定此认证源的用户将无法通过该方式登录。请确认无用户依赖此认证源后再执行删除。",
        invalidUrl: "请输入有效的 URL，以 http:// 或 https:// 开头",
        encryptedServer: "-------- 服务器端加密 --------",
        disableTip: "提示",
        disableContent: "禁用此登录方式可能导致部分用户无法登录,是否确定继续?",
        disableContentWithAction: "{action}此登录方式可能导致部分用户无法登录,是否确定继续?",
        manualTip: "",
        ...
        feishu: "飞书",
        dingtalk: "钉钉",
        addOAuthProvider: "添加OAuth提供商",
        authTypeLabel: "认证类型",
        genericProvider: "通用OAuth提供商",
        clientId: "客户端ID (Client ID)",
        clientIdTip: "OAuth 提供商分配的客户端 ID",
        clientSecret: "客户端密钥 (Client Secret)",
        clientSecretTip: "OAuth 提供商分配的密钥，将加密存储在服务器端",
        scope: "作用域 (Scope)",
        scopeTip: "OAuth 权限范围，多个用空格分隔，如 openid profile email",
        sourceMappings: "来源映射 (Source Mappings)",
        wellKnownIssuer: "Well-Known / Issuer Endpoint",
        issuerEndpoint: "发行方端点 (Issuer Endpoint)",
        issuerOptionalHint: "可选 (Optional)。OIDC 提供商可填写发现端点自动填充配置；非 OIDC 提供商（如 Gitee）留空，手动配置各端点即可。",
        wellKnownEndpoint: "Well-Known 端点 (Well-Known Endpoint)",
        wellKnownEndpointTip: "OIDC 发现端点 URL，根据 Issuer URI 自动生成，可手动修改。",
        fetchConfig: "获取配置",
        fetchingConfig: "获取中...",
        ...
        sectionSettings: "设置",
        source: "来源 (Source)",
        sourceTip: "唯一标识符，用于系统区分不同提供商，建议使用英文字母和连字符",
        sourceName: "来源名称 (Source Name)",
        sourceNameTip: "显示在登录页面和身份源列表中的名称",
        sourceIcon: "来源图标 (Source Icon)",
        sourceIconTip: "显示在登录按钮中的图标，可选择预设图标或输入自定义图片URL",
        imageUrlPlaceholder: "请输入图片 URL，如 https://example.com/logo.png",
        uploadImage: "上传图片",
        sourceIssuerURI: "发行方URI (Issuer URI)",
        sourceIssuerURITip: "OIDC 发现端点，填写后可自动填充下方的授权端点、令牌端点和用户信息端点",
        sourceAuthorizationEndpoint: "授权端点 (Authorization Endpoint)",
        sourceAuthorizationEndpointTip: "OAuth 授权端点 URL，从认证提供商处获取",
        sourceTokenEndpoint: "令牌端点 (Token Endpoint)",
        sourceTokenEndpointTip: "OAuth 令牌端点 URL，用于换取 Access Token",
        sourceUserInfoEndpoint: "用户信息端点 (User Info Endpoint)",
        sourceUserInfoEndpointTip: "获取用户信息的 API 端点 URL",
        userCanSelectAccounts: "用户可以选择账户",
        userCanSelectAccountsTip: "开启后用户登录时可以选择使用哪个账户",
        lastEnabledConfig: "这是最后一个启用的身份源配置,禁用后用户将无法登录.",
        genericStep1: "步骤 1 (Step 1)",
        genericStep1Desc: "发行方端点 (Issuer Endpoint)",
        genericStep2: "步骤 2 (Step 2)",
        genericStep2Desc: "提供商详情 (Provider Details)",
        genericStep3: "步骤 3 (Step 3)",
        genericStep3Desc: "字段映射 (Mapping)",
        issuerFetchFailed:
          "无法从发行方端点获取OIDC配置，请检查URL或手动填写提供商详细信息。",
        issuerFetchTimeout:
          "请求发行方端点超时，请检查URL或手动填写提供商详细信息。",
        issuerFetchSuccess: "成功获取OIDC配置并自动填充端点。",
        genericHelpTitle: "配置示例 (Configuration Examples)",
        genericHelpAuthingName: "Authing（推荐 / Recommended）",
        genericHelpAuthingDesc: "支持OIDC自动发现，只需输入Issuer端点即可自动填充其他端点。",
        genericHelpAuthingIssuer: "Issuer端点: https://'{your-app}'.authing.cn/oidc",
        genericHelpAuthingMappings: "字段映射: uid→sub, email→email, username→name, avatar→picture",
        genericHelpAuthingScope: "Scope: openid profile email",
        genericHelpGiteeName: "Gitee",
        genericHelpGiteeDesc: "不支持OIDC自动发现，需要手动填写所有端点。",
        genericHelpGiteeAuthEndpoint: "授权端点: https://gitee.com/oauth/authorize",
        genericHelpGiteeTokenEndpoint: "令牌端点: https://gitee.com/oauth/token",
        genericHelpGiteeUserInfoEndpoint: "用户信息端点: https://gitee.com/api/v5/user",
        genericHelpGiteeMappings: "字段映射: uid→id, email→email, username→login, avatar→avatar_url",
        genericHelpGiteeScope: "Scope: user_info",
        genericHelpRequired: "必填",
        genericHelpOptional: "可选",
        presetAuthing: "Authing (OIDC 自动发现)",
        presetGitee: "Gitee (手动配置)",
        addGenericProvider: "+ 添加通用 OAuth 提供商",
        duplicateSource: "来源标识（Source）重复，请使用不同的值。",
        presetOidcHint: "已填入 Issuer URI 模板，请将 '{your-app}' 替换为您的应用域名后点击「获取配置」自动填充端点。",
        presetManualHint: "已自动填充 {name} 的端点配置信息。",
    },
    slotControl: {
    ...
    library: {
        title: "库文件管理",
        description: "管理 JavaScript 和 CSS 库文件，用于自定义组件中引用",
        onlineLibraries: "在线库",
        sharedLibraries: "共享库",
        orgLibraries: "组织库",
        uploadShared: "上传共享库（所有组织可用）",
        uploadOrg: "上传组织库（仅本组织可用）",
        selectFile: "选择文件",
        uploadHint: "支持 .js 和 .css 文件，单个文件最大 10MB",
        filename: "文件名",
        displayName: "显示名称",
        version: "版本号",
        fileType: "类型",
        ...
        addToPreload: "添加",
        added: "已添加",
        deleteConfirm: "确定要删除此库文件吗？",
        uploadSuccess: "上传成功",
        uploadFailed: "上传失败",
        deleteSuccess: "删除成功",
        deleteFailed: "删除失败",
        loadFailed: "加载库文件列表失败",
        invalidFileType: "只支持 .js 和 .css 文件",
        fileTooLarge: "文件大小不能超过 10MB",
        uploadMetadata: "上传库文件",
        upload: "上传",
        displayNameRequired: "请输入显示名称",
        displayNamePlaceholder: "例如：jQuery、Bootstrap",
        versionRequired: "请输入版本号",
        versionPlaceholder: "例如：3.6.0、5.1.3",
        libraryDescription: "描述",
        descriptionPlaceholder: "简要描述此库的用途（可选）",
        libraryId: "库标识符",
        referenceHint: "引用方式：/api/libraries/shared/{libraryId}@{version}.js",
    },
};