export const en = {
  ...
  more: "More",
  search: "Search",
  bottomSearch: "Search name or commentary",
  back: "Back",
  ...
  gridCompOperator: {
    ...
    cutCompsSuccess: "Components cut success! You can use {pasteKey} to paste, or use {undoKey} to undo.",
    copyCompsSuccess: "Components copy success! You can use {pasteKey} to paste.",
    pasteCompsSuccess: "Paste success!",
    pasting: "pasting，please wait...",
    pasteCompsFailed: "faild",
  },
  leftPanel: {
    queries: "Queries",
    globals: "Globals",
  ...
  bottomPanel: {
    ...
    allData: "All tables",
    modifyCommentary: "Modify commentary",
  },
  rightPanel: {
  ...
  prop: {
    ...
    minDate: "Min date",
    minDateTip: "Exceeds Minimum Date",
    maxDate: "Max date",
    maxDateTip: "Exceeds Maximum Date",
    minTime: "Min time",
    minTimeTip: "Exceeds Minimum Time",
    maxTime: "Max time",
    maxTimeTip: "Exceeds Maximum Time",
    type: "Type",
  ...
  eventHandler: {
    ...
    setPersistentState: "Set persistent state",
    operation: "Operation",
    set: "Set",
    remove: "Remove",
    clear: "Clear",
    selectOrInputKey: "Select or input key",
    key: "Key",
    value: "Value",
    state: "State",
  ...
  style: {
    ...
    tips: "Tips",
    noStyleAdded: "No style added",
    inputColorError: "the argument must be type CSS color",
    inputColorOrBooleanError: "the argument must be type CSS color or Boolean",
    inputBorderError: "The type of the parameter must be the border style type in CSS",
    inputPaddingOrMarginError: "The type of the parameter must be the padding/margin format type in CSS",
    inputRadiusError: "The type of the parameter must be the radius format type in CSS",
    compBackground: "Component background",
    compBorder: "Component border",
    compRadius: "Component Border radius",
    compPadding: "Component padding",
    compMargin: "Component margin",
  ...
  validationDesc: {
    ...
    urlHelp: "Please enter a valid URL",
    regex: "Regex",
    regexHelp: "Please enter the content that matches the regex",
    idCard: "ID Card",
    idCardHelp: "Please enter a valid ID Card",
    account: "Account",
    accountHelp: "The first character of the account must be a letter, and the account can only contain letters, numbers, and underscores, with a character count greater than 4 and less than 15",
    maxLength:
  ...
  query: {
    ...
    cloudHosting:
      "Cloud-hosted Barda cannot access your local services with 127.0.0.1 or localhost. Try to connect public network data sources or use a reverse proxy fronting your private services.",
    notCloudHosting:
      "For docker hosted deployment, Barda uses bridge networks, so 127.0.0.1 and localhost are invalid for host addresses. To visit data sources on your local machine, please refer to this",
    ...
    whitelist: "Allowlist",
    whitelistTooltip:
      "Add the following IP addresses of Barda to your data source allowlist when needed.",
    address: "Address: ",
    ...
    unexpectedTimeout: "Unexpected timeout, possibly because your JS code returned a restricted object from the JS sandbox.",
  },
  sqlQuery: {
  ...
  uiComp: {
    ...
    qrCodeCompKeywords: "",
    statisticCardCompName: "Statistic Card",
    statisticCardCompDesc: "Statistic Card component for displaying statistics",
    statisticCardCompKeywords: "",
    formCompName: "Form",
    ...
    commentCompDesc: "Comment component",
    commentCompKeywords: "",
  ...
  table: {
    ...
    hasUncompleted: "has uncompleted",
    action: "Action",
    ...
    allowCustomTags: "Custom Tags",
    allowCustomTagsTooltip: "When enabled, users can input custom tags. When disabled, users can only select from predefined tags in the tag configuration.",
    colorMap: "Color Map",
    colorMapTooltip: "Set tag color mapping, supports specifying colors for specific tags or using default for default color. Supported color types: success/processing/error/warning/default, common color names like red/orange/blue, or hex colors like #ff0000/#123456. ",
    date: "Date",
    dateTime: "Date Time",
    badgeStatus: "Status",
    button: "Button",
  ...
  image: {
    ...
    scaleDown: "scaleDown",
    objectFit: "objectFit",
    objectFitTip: "Set the filling method for the image",
  },
  progress: {
    value: "Value",
  ...
  statisticCard: {
    title: "Title",
    titleTooltip: "The title text of the statistic card",
    value: "Value",
    valueTooltip: "The value displayed in the statistic card",
    valueDesc: "The value of the statistic card",
    prefix: "Prefix",
    prefixTooltip: "Prefix text displayed before the value, such as currency symbols, units, etc.",
    suffix: "Suffix",
    suffixTooltip: "Suffix text displayed after the value, such as units, percentage symbols, etc.",
    precision: "Precision",
    precisionTooltip: "Number of decimal places, range 0-20",
    prefixColor: "Prefix Color",
    suffixColor: "Suffix Color",
    secondaryIndicator: "Sub Indicator",
    showSecondaryIndicator: "Show Sub Indicator",
    showSecondaryIndicatorTooltip: "Show a sub indicator next to the primary indicator",
    secondaryValue: "Sub Value",
    secondaryValueTooltip: "The sub value displayed next to the primary indicator",
    secondaryPrefix: "Sub Prefix",
    secondaryPrefixTooltip: "Prefix text displayed before the sub value",
    secondarySuffix: "Sub Suffix",
    secondarySuffixTooltip: "Suffix text displayed after the sub value",
    secondaryPrecision: "Sub Precision",
    secondaryPrecisionTooltip: "Number of decimal places for the sub indicator, range 0-20",
    secondaryValueColor: "Sub Value Color",
    secondaryValueFontSize: "Sub Value Font Size",
    secondaryPrefixColor: "Sub Prefix Color",
    secondarySuffixColor: "Sub Suffix Color",
    size: "Size",
    sizeTooltip: "Normal matches default spacing, compact reduces padding and icon size",
    sizeNormal: "Normal",
    sizeCompact: "Compact",
    icon: "Icon",
    iconTooltip: "The icon of the statistic card",
    enableAnimation: "Enable Animation",
    enableAnimationTooltip: "When enabled, the value will animate from 0 to the target value",
  ...
  drawer: {
    ...
    bottom: "Bottom",
    left: "Left",
    closeButtonPlacement: "Close button placement",
  ...
  settings: {
    ...
    lab: "Lab",
    branding: "Branding",
    idSource: "Identity Source Management",
    premium: "Premium",
  },
  memberSettings: {
    admin: "Admin",
  ...
  modalComp: {
    ...
    codeOnlyClose: "Disable user close",
    codeOnlyCloseTooltip: "When enabled, the modal can only be closed by code, no close button will be shown, [Edit mode] allows clicking the mask to close",
  ...
  advanced: {
    ...
    AuthOrgLoginUrlDesc: "Organization Login URL (click to copy)",
    AuthOrgRedirectUriDesc: "OAuth Redirect URI (use when configuring OAuth provider, click to copy)",
    saveBtn: "Save",
  ...
  branding: {
    ...
    faviconHelp: "Suggest ICO, .JPG, .SVG or .PNG only",
    brandNameTitle: "Brand Name",
    headColorTitle: "Head Color",
    logoContainsName: "Brand name not displayed at the top",
    save: "Save",
    saveSuccessMsg: "Saved successfully",
    upload: "Click to upload",
    typeError: "You can only upload {fileTypes} file!",
    sizeError: "Image must smaller than {size}MB!",
  },
  networkMessage: {
  ...
  apiMessage: {
    ...
    functionNotSupported:
      "The current version does not support this function. Please contact the Barda business team to upgrade your account",
  },
  globalErrorMessage: {
  ...
  appSetting: {
    ...
    embeddingModeDes: "This feature controls whether the top menu is displayed during preview. \nIt is particularly useful when embedding this program into other web pages. \nAdditionally, you can append template=true parameter to the page URL to hide the top menu when accessing directly.",
    normal: "Show",
    embedding: "hidden",
    layoutMode: "Layout mode",
    layoutModeDes: "Grid Mode: Components must be placed within the grid layout.\nFree Mode: Components can be freely positioned anywhere on the canvas.",
    gridMode: "Grid mode",
    freeMode: "Free mode",
    changeLayoutMode: "Change layout mode",
    changeLayoutModePrompt: "Switching to grid mode may adjust component positions. Are you sure you want to switch?",
    confirmText: "Confirm",
  },
  customShortcut: {
  ...
  header: {
    ...
    clone: "Clone",
    left: "Data Browser (Ctrl+B)",
    right: "Attribute/Component Panel (Ctrl+U)",
    bottom: "Query Editor (Ctrl+J)",
  },
  userAuth: {
    ...
    orgWelcomeTitle: "Welcome back to {orgName}",
    terms: "Terms",
    ...
    selectOrgTitle: "Select Workspace",
    selectOrgDesc: "You belong to multiple workspaces. Please select one to continue.",
  ...
  componentDoc: {
    markdownDemoText:
      "**Barda** is a _developer-friendly_ open-source low code platform to build internal apps within minutes.",
    demoText:
      "Barda is a developer-friendly open-source low code platform to build internal apps within minutes.",
    submit: "Submit",
    style: "style",
    danger: "Danger",
    warning: "warning",
  ...
  idSource: {
    title: "Identity Source Management",
    form: "Email",
    pay: "Premium",
    enable: "Enable",
    ...
    save: "Save",
    none: "None",
    aboutIdSource: "About Identity Source",
    ...
    deleteTip: "Tips",
    deleteContent:
      "This will permanently delete this identity provider configuration. This action cannot be undone. Are you sure to proceed?",
    deleteImpactTip:
      "Users bound to this identity provider will lose the ability to log in via this method. Please ensure no users depend on this provider before deleting.",
    ...
    disableContentWithAction:
      "{action} this ID provider may result in some users being unable to log in. Are you sure to proceed?",
    manualTip: "",
    ...
    genericProvider: "Generic OAuth Provider",
    clientId: "Client ID",
    clientIdTip: "The Client ID assigned by your OAuth provider",
    clientSecret: "Client Secret",
    clientSecretTip: "The secret/key assigned by your OAuth provider, stored encrypted server-side",
    scope: "Scope",
    scopeTip: "OAuth scope values, space-separated (e.g. openid profile email)",
    sourceMappings: "Source Mappings",
    wellKnownIssuer: "Well-Known / Issuer Endpoint",
    issuerEndpoint: "Issuer Endpoint",
    issuerOptionalHint: "Optional. For OIDC providers, enter the discovery URL to auto-fill endpoints. For non-OIDC providers (e.g. Gitee), leave empty and configure endpoints manually.",
    wellKnownEndpoint: "Well-Known Endpoint",
    wellKnownEndpointTip: "OIDC discovery URL. Auto-derived from Issuer URI but can be manually overridden.",
    fetchConfig: "Fetch",
    ...
    source: "Source",
    sourceTip: "Unique identifier used by the system to distinguish providers. Use letters and hyphens.",
    sourceName: "Source Name",
    sourceNameTip: "Name displayed on the login page and in the identity source list",
    sourceIcon: "Source Icon",
    sourceIconTip: "Icon shown in the login button. Choose a preset icon or enter a custom image URL.",
    imageUrlPlaceholder: "Enter image URL, e.g. https://example.com/logo.png",
    uploadImage: "Upload",
    sourceIssuerURI: "Issuer URI",
    sourceIssuerURITip: "OIDC discovery endpoint. Enter this to auto-fill the authorization, token, and user info endpoints below.",
    sourceAuthorizationEndpoint: "Authorization Endpoint",
    sourceAuthorizationEndpointTip: "OAuth authorization endpoint URL from your identity provider",
    sourceTokenEndpoint: "Token Endpoint",
    sourceTokenEndpointTip: "OAuth token endpoint URL, used to exchange for an access token",
    sourceUserInfoEndpoint: "User Info Endpoint",
    sourceUserInfoEndpointTip: "API endpoint URL for fetching user information",
    userCanSelectAccounts: "User Can Select Accounts",
    userCanSelectAccountsTip: "When enabled, users can choose which account to use during login",
    lastEnabledConfig:
      "This is the last enabled identity source configuration. After disabling, users will not be able to log in.",
    lockModalContent:
    ...
    payUserTag: "Premium",
    genericStep1: "Step 1",
    genericStep1Desc: "Issuer endpoint",
    genericStep2: "Step 2",
    genericStep2Desc: "Provider details",
    genericStep3: "Step 3",
    genericStep3Desc: "Mapping",
    issuerFetchFailed:
      "Unable to fetch OIDC configuration from the issuer endpoint. Please check the URL or fill in the provider details manually.",
    issuerFetchTimeout:
      "Request to issuer endpoint timed out. Please check the URL or fill in the provider details manually.",
    issuerFetchSuccess: "Successfully fetched OIDC configuration and auto-filled endpoints.",
    genericHelpTitle: "Configuration Examples",
    genericHelpAuthingName: "Authing (Recommended)",
    genericHelpAuthingDesc: "Supports OIDC auto-discovery. Enter the Issuer URL and all endpoints will be auto-filled.",
    genericHelpAuthingIssuer: "Issuer URL: https://'{your-app}'.authing.cn/oidc",
    genericHelpAuthingMappings: "Field mappings: uid→sub, email→email, username→name, avatar→picture",
    genericHelpAuthingScope: "Scope: openid profile email",
    genericHelpGiteeName: "Gitee",
    genericHelpGiteeDesc: "No OIDC auto-discovery. All endpoints must be entered manually.",
    genericHelpGiteeAuthEndpoint: "Authorization Endpoint: https://gitee.com/oauth/authorize",
    genericHelpGiteeTokenEndpoint: "Token Endpoint: https://gitee.com/oauth/token",
    genericHelpGiteeUserInfoEndpoint: "User Info Endpoint: https://gitee.com/api/v5/user",
    genericHelpGiteeMappings: "Field mappings: uid→id, email→email, username→login, avatar→avatar_url",
    genericHelpGiteeScope: "Scope: user_info",
    genericHelpRequired: "Required",
    genericHelpOptional: "Optional",
    presetAuthing: "Authing (OIDC Auto-Discovery)",
    presetGitee: "Gitee (Manual Config)",
    addGenericProvider: "+ Add Generic OAuth Provider",
    duplicateSource: "Duplicate source identifier. Please use a different Source value.",
    presetOidcHint: "Issuer URI template filled. Replace '{your-app}' with your app domain, then click \"Fetch\" to auto-fill endpoints.",
    presetManualHint: "All endpoint fields have been auto-filled for {name}.",
  },
  slotControl: {
  ...
  library: {
    ...
    description: "Manage JavaScript and CSS library files for use in custom components",
    onlineLibraries: "Online Libraries",
    sharedLibraries: "Shared Libraries",
    orgLibraries: "Organization Libraries",
    uploadShared: "Upload Shared Library (Available to all organizations)",
    uploadOrg: "Upload Organization Library (Only available to this organization)",
    selectFile: "Select File",
    uploadHint: "Supports .js and .css files, maximum 10MB per file",
    filename: "Filename",
    ...
    addToPreload: "Add",
    added: "Added",
    deleteConfirm: "Are you sure you want to delete this library file?",
    uploadSuccess: "Upload successful",
    uploadFailed: "Upload failed",
    deleteSuccess: "Delete successful",
    deleteFailed: "Delete failed",
    loadFailed: "Failed to load library file list",
    invalidFileType: "Only .js and .css files are supported",
    fileTooLarge: "File size cannot exceed 10MB",
    uploadMetadata: "Upload Library File",
    upload: "Upload",
    displayNameRequired: "Please enter display name",
    displayNamePlaceholder: "e.g., jQuery, Bootstrap",
    versionRequired: "Please enter version",
    versionPlaceholder: "e.g., 3.6.0, 5.1.3",
    libraryDescription: "Description",
    descriptionPlaceholder: "Brief description of this library (optional)",
    libraryId: "Library ID",
    referenceHint: "Reference: /api/libraries/shared/{libraryId}@{version}.js",
  },
};