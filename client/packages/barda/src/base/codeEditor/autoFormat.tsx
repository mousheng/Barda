import { CodeType } from "barda-core";
import { relaxedJSONToJSON } from "barda-core";
import { getDynamicStringSegments, isDynamicSegment } from "barda-core";
...
async function getJavascriptFormatter() {
  ...
  return (text: string) =>
    prettier.format(text, { parser: "babel", plugins: [parserBabel], semi: false, printWidth: 110 }).trim();
}
