...
const HeaderWrapper = styled.header<IHeaderProps>`
  ...
  background-color: ${props => props.$headerColor ?? "#2c2c2c"};
...
export default function Header(props: IHeaderProps) {
  ...
  const { $headerStart: headerStart, $headerMiddle: headerMiddle, $headerEnd: headerEnd } = props;
  ...
  return (
    <HeaderWrapper
      ...
      $style={props.$style}
      $headerColor={brandingConfig?.headerColor}
    >
