import { AddIcon, CloseIcon, CustomModalProps, ImportIconV2, ScrollBar } from "barda-design";
...
import { Datasource } from "@barda/constants/datasourceConstants";
import {
  BARDA_API_ID,
  BARDA_API_INFO,
  QUICK_GRAPHQL_ID,
...
import { ResourceType } from "@barda/constants/queryConstants";
...
const ResButton = (props: {
  ...
  const data: any = {
    ...
    bardaApi: {
      icon: BARDA_API_INFO.icon,
      label: BARDA_API_INFO.name,
      type: BottomResTypeEnum.Query,
      extra: {
        compType: "bardaApi",
...
export const ResCreatePanel = memo((props: ResCreateModalProps) => {
          ...
          <InnerContent>
            ...
            <div className="section">
              <DataSourceListWrapper $placement={placement}>
                ...
                {placement === "editor" && (
                  <ResButton size={buttonSize} identifier={"bardaApi"} onSelect={onSelect} />
                )}
