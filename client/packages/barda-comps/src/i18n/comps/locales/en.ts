export const en = {
  ...
  calendar: {
    ...
    addedEvent: "Added event",
    changedEvent: "Changed event",
    currentEvent: "Current event",
    confirmDelete: "Confirm before delete",
    confirmDeleteTooltip: "When enabled, clicking delete will show a confirmation popover",
    deleteConfirmTitle: "Delete event",
    deleteConfirmDesc: "Are you sure you want to delete this event?",
    addEvent: "Add event",
    addEventDesc: "Triggered when a new event is added",
    editEventLabel: "Edit",
    editEventDesc: "Triggered when an event is edited",
    editable: "Editable",
