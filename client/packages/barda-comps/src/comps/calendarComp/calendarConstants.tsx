...
import {
  backgroundToBorder, contrastText,
  contrastColor, genHoverColor,
  DATE_FORMAT,
  DATE_TIME_FORMAT, isDarkColor,
  darkenColor,
  lightenColor,
  toHex,
  UnderlineCss,
...
export const buttonText = {
  ...
  multiMonth: trans("calendar.year"),
};

export const headerToolbar = {
  left: "title",
  right: "prev today next multiMonth,dayGridMonth,timeGridWeek,timeGridDay,listWeek",
};
// 周标题渲染
